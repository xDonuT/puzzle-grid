...
(function () {
  ...
  const CODEX = {
    creatures: [
      ...
      { id: "thorn", icon: "🌿", name: "Bramble", tier: "common", passive: "Spikes", desc: "Reflects 1 damage when hit. A tangle of brambles that bites back." },
      ...
      { id: "bracken", icon: "🌳", name: "Bracken the Rootbound", tier: "boss", passive: "Root Snare", desc: "Ultimate: Blind + heavy hit + Disoriented (controls reversed 2t) + Curses 3 tiles. Warden of the Sprout, bound to ancient roots." },
      { id: "cinder", icon: "🌨️", name: "Squall Queen", tier: "boss", passive: "Bloom Counter", desc: "Each hit adds a Bloom stack (+4% DR, cap 8). At 5+ stacks she heals 2 HP/turn. Ultimate: Ashstorm — Poison + burst + Curses 2 tiles." },
      { id: "lastrival", icon: "⚔️", name: "The Last Rival", tier: "boss", passive: "Regen + Cracked", desc: "Regenerates 3 HP/turn. Every hit applies Cracked (2 true dmg/stack). Ultimate: Earthshatter — Massive hit + Bleed + Root Bind + Curses 2 tiles." }
    ],
    ...
    modifiers: [
      ...
      { id: "firstStrike", icon: "💥", name: "First Strike", tier: "easy", desc: "First match of the floor is Bloom (4+)." },
      ...
      { id: "mirrorMatch", icon: "🦴", name: "Mirror Match", tier: "hard", desc: "Enemy starts with Cracked 3 — plan your Shatter." },
    ...
    upgrades: [
      ...
      { id: "apCarry", icon: "⚡", name: "Extra Action", desc: "Unused AP carries over up to +2 next turn." },
      { id: "boardWhisper", icon: "🔄", name: "Free Shuffle", desc: "1 free Shuffle each floor." },
      ...
      { id: "mortalStrike", icon: "⚔️", name: "Weaken", desc: "Knight: Ultimate also reduces enemy damage by 25% for 2 turns.", classReq: "knight" },
      { id: "bulwark", icon: "🛡️", name: "Bulwark", desc: "Knight: Shield matches apply 1 Cracked stack (once per turn).", classReq: "knight" },
    ...
    passives: [
      ...
      // Knight
      { id: "frc1", icon: "💥", name: "Deep Cracked", classReq: "knight", tier: 1, desc: "Cracked +1 true dmg/stack." },
      { id: "frc2", icon: "💥", name: "Shatter+", classReq: "knight", tier: 2, desc: "Shatter deals x1.5 damage." },
      { id: "frc3", icon: "💥", name: "Earthquake", classReq: "knight", tier: 3, desc: "Shatter makes enemy Dizzy 1 turn." },
      ...
      { id: "vlr3", icon: "🔥", name: "Power Strike", classReq: "knight", tier: 3, desc: "Ult spends all shield for damage." }
    ],
    ...
    statuses: [
      ...
      { id: "stun", icon: "⚡", name: "Dizzy", desc: "Enemy skips their next turn entirely." },
      { id: "frost", icon: "❄️", name: "Chill", desc: "Enemy loses 1 AP at the start of their turn." },
      { id: "corrupted", icon: "💜", name: "Cursed", desc: "Matching this tile deals 8 damage to YOU instead of the enemy!" },
      ...
      { id: "fracture", icon: "🦴", name: "Cracked", desc: "At the start of the enemy's turn they take 2 true damage per stack (max 5)." },
      { id: "mortal", icon: "💔", name: "Bleed", desc: "Healing is halved for the listed turns." },
